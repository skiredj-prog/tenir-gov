...
class KeyCeremony:
    ...
    Deploy secret must be set via environment variable: TENIR_OATH_SECRET
    """

    OATH_TEXT = "J'assume la friction. Je préserve le TAU."
    OATH_TEXT_FR = "J'assume la friction. Je préserve le TAU."

    def __init__(self, deploy_secret: str = "TENIR_R5_DEFAULT_SECRET_CHANGE_IN_PROD"):
...
def get_ceremony(secret: str = "TENIR_R5_DEFAULT_SECRET_CHANGE_IN_PROD") -> KeyCeremony:
    global _ceremony
    if _ceremony is None:
        _ceremony = KeyCeremony(deploy_secret=secret)
    return _ceremony
